...
export default class SignIn extends Component {
  ...
  componentDidMount() {this.handleSubmit = this.handleSubmit.bind(this)
   console.log(this.state.fName, 'fname in state')
  }

  handleSubmit(e) {
    e.preventDefault()  
    console.log(this, 'state in handsub')
    console.log(this.state.fName, 'fname in the handlesubmit')
  ...
  handleChange = (e) => {
      console.log(e.target.name, 'targeeeet')
    this.setState({
